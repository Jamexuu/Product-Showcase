...
const chatAvatar = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 1024 1024" fill="white">
...
const avatarBootstrap = "chat-avatar bg-dark rounded-circle d-flex align-items-center justify-content-center flex-shrink-0";
...
function addMessage(text, isUser) {
    ...
    wrapper.className = `d-flex mb-2 gap-2 ${isUser ? "justify-content-end" : "justify-content-start"}`;
    ...
    cardBody.className = `card-body p-3 rounded-4 ${isUser ? "bg-dark text-white" : ""}`;
...
sendBtn.addEventListener("click", () => {
    ...
    if (text) {
        ...
        tempWrapper.className = "d-flex justify-content-start mb-2 gap-2";
        ...
        tempBubble.innerHTML = `<div class="card-body p-3 rounded-4"><small class="text-dark" id="${replyId}">...</small></div>`;
